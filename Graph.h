...
class Graph {
    private:
        unordered_map<string, list<pair<string, string>>> adj_list;
        unsigned int num_of_nodes = 0;
        unsigned int num_of_edges = 0;
        vector<string> labels;
        string file_name;
        unordered_map<string,string> parent_dj;
    ...
    public:
        ...
        void add_edge(string u, string v, string weight);
        ...
        // Helper for connected_components.
        void DFS_CC(string vertex, unordered_map<string, bool>& visited, vector<string>& component, double threshold);
        /**
        ...
        void union_dj(string l, string r);
        /**
